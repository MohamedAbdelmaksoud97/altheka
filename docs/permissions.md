...
- `project_teams.manage` ينشئ الفريق ويعدل اسمه وقائده ومرحلته وحالته وفترته.
- `project_teams.assign` يضيف العضو أو يغير دوره وينهي عضويته بسبب إلزامي.
- أدوار الفريق التشغيلية هي `leader`, `member`, `observer`. الأولان فقط
  يدخلان في حل منفذ Workflow، بشرط امتلاك `tasks.submit`.
- مدير وسكرتير التقاضي ومدير وسكرتير التركات يملكون صلاحيات الفرق ضمن نطاق
  وصولهم، و`super_admin` يملك التدخل العام.
- المحاسب يملك `tasks.submit` لتنفيذ إجراءات فريق المالية، لكنه لا يسند
  تلقائيًا إلا إذا أضيف عضوًا منفذًا إلى الفريق المطابق.
- لا يستطيع السكرتير تكليف نفسه إلا بسلطة مدير مشروع أو مدير إدارة، ولا يمكن
  إزالة قائد الفريق قبل تعيين قائد بديل أو إخلاء القيادة صراحة.
